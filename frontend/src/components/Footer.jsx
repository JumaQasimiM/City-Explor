      ...
      <div className="max-w-7xl mx-auto px-5 border-t-2 border-t-gray-500 pt-5">
          ...
          <div>
            ...
            <form className="flex" onSubmit={handleSubscribe}>
              <input
                ...
                className="w-full px-3 py-2 text-sm dark:bg-slate-800 bg-slate-300 border border-white/10 rounded-l-md focus:outline-none focus:border-green-400"
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-6 gap-4">
          ...
          <div className="flex items-center gap-4">
            <a className="p-2 rounded-full bg-slate-400 dark:bg-slate-800 hover:bg-green-500 transition cursor-pointer">
              <FaFacebookF size={14} />
            </a>
            <a className="p-2 rounded-full bg-slate-400 dark:bg-slate-800 hover:bg-green-500 transition cursor-pointer">
              <FaInstagram size={14} />
